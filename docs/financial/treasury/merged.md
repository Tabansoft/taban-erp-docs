...
| :--- | :--- | :--- | :--- |
| **شخص حقوقی** | `LegalEntityID` | FK | **(حیاتی)** مالک قانونی حساب کیست؟ <br> *منطق:* تمام اسناد حسابداری این حساب در دفاتر کل (General Ledger) این شرکت ثبت می‌شود. |
...
| **شخص حقوقی** | `LegalEntityID` | مالک قانونی این پول کدام شرکت شماست؟ <br> *نکته فنی:* سند حسابداری در دفاتر کل (GL) این شرکت ثبت می‌شود. انتقال پول بین دو صندوق از دو بنگاه مختلف، نیازمند سند "حساب جاری شرکا" است. |
| **سایت** | `OperatingUnitID` | این صندوق فیزیکاً در کدام ساختمان یا شعبه است؟ (مثلاً: کارخانه کرج). <br> *کاربرد:* فیلتر کردن دسترسی کاربران بر اساس شعبه. |
...
| **شخص حقوقی** | `LegalEntityID` | مالک قانونی اسناد. سند حسابداری جابجایی چک در دفاتر این شرکت ثبت می‌شود. |
| **سایت** | `OperatingUnitID` | محل فیزیکی نگهداری چک (مثلاً: دفتر مرکزی تهران). |
...
### الف) شخص حقوقی (Legal Entity) و خزانه‌داری

همانطور که در مستندات تابان ذکر شده، **شخص حقوقی** یک موجودیت حقوقی مستقل با گزارش‌های مالی مستقل است.

> **قانون کلیدی خزانه‌داری:** **حساب‌های بانکی** (Bank Accounts) و **دسته چک‌ها** (Checkbooks) در سطح **شخص حقوقی** تعریف و تملک می‌شوند.

* از آنجایی که ترازنامه و صورت‌های مالی در سطح شخص حقوقی تهیه می‌شود، حساب بانکی که یکی از اقلام اصلی دارایی‌های جاری است، باید متعلق به یک شخص حقوقی مشخص باشد.
* **مثال:** اگر «ایران خودرو مرکزی» (کد 1000) و «بخش فروش و بازاریابی» (کد 2000) دو شخص حقوقی جداگانه باشند، هر کدام باید حساب‌های بانکی، دسته چک‌ها و اسناد مالی مجزای خود را در سیستم داشته باشند. نمی‌توان چکی را از حساب بنگاه 1000 برای پرداخت فاکتور بنگاه 2000 (مگر در فرآیندهای مالی بین شرکتی) استفاده کرد.

### ب) سایت (Site) و خزانه‌داری

**سایت** یک مکان فیزیکی (مانند کارخانه، انبار یا دفتر) است که در آن فرآیندهای لجستیکی و عملیاتی رخ می‌دهد.

> **قانون کلیدی خزانه‌داری:** **صندوق‌ها (Petty Cash)** و **تنخواه‌گردان‌ها** معمولاً در سطح **سایت** مدیریت می‌شوند.

* در حالی که حساب‌های بانکی ماهیت حقوقی دارند، صندوق‌ها ماهیت فیزیکی و مکانی دارند.
* **مثال:** برای پوشش هزینه‌های نقدی روزمره «کارخانه تهران» (سایت 1100) یا «دفتر مرکزی اداری» (مکان 1500)، یک «صندوق» یا «تنخواه» در سیستم تعریف می‌شود که به آن سایت و یک فرد مسئول (تنخواه‌گردان) مرتبط است.
...
4.  **ماژول داده‌های پایه (MDM):** اطمینان می‌دهد که این عملیات در چارچوب ساختار سازمانی صحیح (شخص حقوقی و سایت) انجام می‌شود.
...
| :--------------------- | :----------- | :------------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **شخص حقوقی**      | انتخابی (FK) | بله                       | بنگاهی که تراکنش مالی را انجام می‌دهد.                                                                                                                                                                                                                                                        |
