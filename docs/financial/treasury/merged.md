...
### ب) مکان عملیاتی (Site) و خزانه‌داری
...
4.  **ماژول داده‌های پایه (MDM):** اطمینان می‌دهد که این عملیات در چارچوب ساختار سازمانی صحیح (شخص حقوقی و مکان عملیاتی) انجام می‌شود.
