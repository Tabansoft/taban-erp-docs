...
مکان عملیاتی، یک واحد سازمانی عملیاتی در تابان است که یک **_مکان فیزیکی_** (مانند یک کارخانه، انبار، دفتر، مرکز توزیع یا شعبه فروش) را نشان می‌دهد. بر خلاف شخص حقوقی که یک شخص حقوقی و مالی است، مکان عملیاتی یک واحد لجستیکی و عملیاتی است که در آن فرآیندهای کسب‌وکار روزمره مدیریت می‌شوند.
...
## ارتباط مکان عملیاتی با شخص حقوقی

هر مکان عملیاتی همیشه به یک شخص حقوقی اختصاص داده می‌شود. یک شخص حقوقی می‌تواند چندین مکان عملیاتی داشته باشد، اما یک مکان عملیاتی تنها می‌تواند به یک شخص حقوقی مرتبط باشد. این ارتباط به تابان امکان می‌دهد تا هزینه‌های عملیاتی یک مکان فیزیکی را با حساب‌های مالی مربوط به یک شخص حقوقی (شخص حقوقی) پیوند دهد.
...
- مکان عملیاتی، واحدی است که کاری در آن انجام می شود، نه مالی، اما تحت شخص حقوقی فعالیت می‌کند.

- مکان عملیاتی می‌تواند یک **کارخانه، انبار یا مرکز تعمیر و خدمات** باشد.

- هر مکان عملیاتی **به یک** **شخص حقوقی** **وصل می‌شود** و اسناد مالی آن از طریق شخص حقوقی ثبت می‌شود.
...
| کد مکان عملیاتی | نام مکان عملیاتی | کد شخص حقوقی | نوع فعالیت | توضیح کاربرد |
| --- | --- | --- | --- | --- |
...
- **مکان عملیاتی** **به** **شخص حقوقی** **وصل است**

    - مکان عملیاتی تولیدی (1100، 1200) به شخص حقوقی  1000

    - مکان عملیاتی خدمات (1300، 1400) به شخص حقوقی  3000

    - مکان عملیاتی فروش (1600، 1700) به شخص حقوقی  2000
