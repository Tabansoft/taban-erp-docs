...
**مسیر:**
`مدیریت تولید / تعاریف پایه / منابع`
...
1.  **تفاوت راندمان و ضریب عملکرد (بسیار مهم):**
    * **راندمان (Efficiency):** بر *زمان تقویم* تأثیر می‌گذارد. اگر تقویم ۸ ساعت و راندمان ۹۰٪ باشد، سیستم می‌داند که فقط $۸ \times ۰.۹ = ۷.۲$ ساعت از این منبع برای برنامه‌ریزی در دسترس است (۱۰۰٪ - ۹۰٪ = ۱۰٪ زمان صرف توقفات برنامه‌ریزی شده، استراحت و ... می‌شود).
...
| **نوع منبع (Resource Type)** | وابسته | هر منبع باید یک نوع داشته باشد (Many-to-One) |
| **قابلیت (Capability)** | وابسته | هر منبع می‌تواند چندین قابلیت داشته باشد (Many-to-Many) |
