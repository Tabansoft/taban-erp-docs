# فرمول‌ تولید (Bill of Materials - BOM)
...
**مسیر:**
`مدیریت تولید / مهندسی / فرمول‌های تولید (BOM)`
...
۱. **هدر (Header):** اطلاعات کلی BOM (برای کدام محصول و چه مقداری).
...
1.  **اهمیت مقدار پایه:** تمام مقادیر اجزا (Lines) باید نسبت به «مقدار پایه» (Header) تعریف شوند. اگر مقدار پایه ۱ (عدد) دوچرخه باشد، مقدار لاستیک ۲ (عدد) است. اگر مقدار پایه ۱۰۰۰ (کیلوگرم) خوراک طیور باشد، مقدار ذرت ۴۰۰ (کیلوگرم) است.
...
3.  **ضایعات (Scrap):** اگر برای تولید ۱ دوچرخه (مقدار پایه) به ۲ متر لوله نیاز دارید (مقدار) اما ۵٪ ضایعات برشکاری دارید، باید در فیلد ضایعات ۵٪ را وارد کنید. سیستم هنگام برنامه‌ریزی، $۲ \times ۱.۰۵ = ۲.۱$ متر لوله درخواست خواهد کرد.
