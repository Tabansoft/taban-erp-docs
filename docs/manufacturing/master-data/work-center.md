...
**مرکز کار (Work Center)** یک واحد سازمانی در سطح واحد عملیاتی (Site) است. این مرکز می‌تواند یک دستگاه واحد، گروهی از دستگاه‌های مشابه (مانند «کارگاه تراش»)، یا یک خط مونتاژ باشد. در «فرآیند تولید» (Routing)، عملیات به مراکز کاری تخصیص داده می‌شوند.
...
| **سایت (Site)** | انتخابی | واحد سازمانی بالاتر (مثلاً «کارخانه تولید خوراک طیور») |
...
| کد | نام | سایت | تقویم کار | قاعده تخصیص | منابع در دسترس |
| :--- | :--- | :--- | :--- | :--- | :--- |
